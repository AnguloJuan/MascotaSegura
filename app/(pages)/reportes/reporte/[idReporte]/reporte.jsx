    ...
    return (
        <>
                ...
                <div className="perfilEmpleado">
                    ...
                    <div className="datos-reporte">
                        ...
                        <div className="input mb-3 mt-3">
                            ...
                            <Municipios handleChange={handleInputChange} municipiosInicial={props.municipios} selectedEstado={reporte.estado} value={reporte.municipio} />
                        </div>
                        <div className="input mb-3 mt-3">
                            <label htmlFor="descripcion" className="form-label">Descripción</label>
                            <textarea name="descripcion" id="descripcion" rows="5" placeholder="Descripción"
                                onChange={handleInputChange} value={reporte.descripcion} className="form-control"></textarea>
                        </div>
            ...
            <Dialog id={"invalidField"} isOpen={invalidFieldsDialog} onClose={() => setInvalidFieldsDialog(false)}>
                ...
                <p>En los campos estado, municipio, y Estado reporte debe haber seleccionado una opción</p>
            </Dialog>
